...
class ModelSelection:
    ...
    def fit(self, x_train, y_train, x_test, y_test):
        ...
        try:
            ...
            self.logger.error(f'error in ModelSelection fit e: {e}')
            raise e
    ...
    def log_metrics(self, mlflow, score, confusion_mtx, roc_auc, precision, recall, f1_score):
        ...
        try:
            ...
            self.logger.error(f'error in ModelSelection log_metrics e: {e}')
            raise e
    ...
    def log_roc_auc_artifact(self, model, x_test, y_test):
        ...
        try:
            ...
            self.logger.error(f'error in ModelSelection log_roc_auc_artifact e: {e}')
            raise e
    ...
    def log_confusion_matrix_artifact(self, model, x_test, y_test):
        ...
        try:
            ...
            self.logger.error(f'error in ModelSelection log_confusion_matrix_artifact e: {e}')
            raise e
    ...
    def log_feature_importance_artifact(self, model):
        ...
        try:
            ...
            self.logger.error(f'error in ModelSelection log_feature_importance_artifact e: {e}')
            raise e
